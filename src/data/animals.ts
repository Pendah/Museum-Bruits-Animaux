...
export const animals: Animal[] = [
  ...
  },
  {
    ...
    description:
      "La genette commune est un petit carnivore nocturne aux allures de chat sauvage. Elle émet des miaulements, des grognements et des cris aigus pour marquer son territoire et communiquer, principalement active la nuit.",
  ...
  },
  {
    ...
    description:
      "La chouette hulotte est un rapace nocturne emblématique des forêts européennes. Elle émet un hululement caractéristique qui résonne dans la nuit, utilisé pour marquer son territoire et communiquer avec son partenaire.",
    soundFile: "/assets/sounds/hulotte.mp3",
    videoFile: "/assets/videos/hulotte.jpg",
